...
?>
		<html>
			<head>
				...
				<title>Envie sua pergunta - Talkplay</title>
			...
			<body bgcolor='#DCDCDC' link="#E1E1E1" alink="#E1E1E1" vlink="#E1E1E1" onload="tempoatualiza();">
				...
				?>
				<?php echo "<form method='post' action='cadastrarpergunta.php'>
				<table>
					<td><font face='Arial'><b>Escolha uma categoria: </b></font></td>
					<td>
						<select name='opcao' id='opcao1'>
							<option name='aa'></option>
							<option name='Conhecimentos gerais - Harry Potter'>Conhecimentos gerais - Harry Potter</option>
							<option name='Perguntas de lógica'>Perguntas de lógica</option>
						</select>
					</td>
					<tr>
						<td><font face='Arial'>Digite a pergunta(Máximo de 255 caracteres)</font></td>
						<td><textarea rows='9' cols='50' name='pergunta' name='pergunta'></textarea></td>
					</tr>
					<tr>
						<td><input type='text' name='alternativa1' placeholder='Alternativa A(Exemplo A-...)'></td>
					</tr>
					<tr>
						<td><input type='text' name='alternativa2' placeholder='Alternativa B(Exemplo B-...)'></td>
					</tr>
					<tr>
						<td><input type='text' name='alternativa3' placeholder='Alternativa C(Exemplo C-...)'></td>
					</tr>
					<tr>
						<td><input type='text' name='alternativa4' placeholder='Alternativa D(Exemplo D-...)'></td>
					</tr>
					<tr>
						<td><input type='text' name='alternativacerta' placeholder='Digite a resposta certa'></td>
					</tr>
					<tr>
						<td><input type='submit' value='Enviar pergunta' id='btperguntar'></td>
					</tr>
				</table>
				<input type='hidden' value='$_nick' name='nick'>
				<input type='hidden' value='$_caminho' name='img'>
				</form>" ?>
			</body>
		</html>
<?php
